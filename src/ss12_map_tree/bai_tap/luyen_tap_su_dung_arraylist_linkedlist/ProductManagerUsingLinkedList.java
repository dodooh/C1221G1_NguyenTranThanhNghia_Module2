...
public class ProductManagerUsingLinkedList {
    ...
    void displayMainMenu() {
        ...
        boolean flag = true;
        do {
            System.out.println("========CHƯƠNG TRÌNH QUẢN LÝ SẢN PHẨM SỬ DỤNG LINKEDLIST=========");
    ...
    void findByName(String productName){
        LinkedList<Product> productsSameName = new LinkedList<>();
        for (Product product: products ) {
    ...
    void displayListProducts(LinkedList<Product> productsList) {
